	...
	@section('main-content')
		<section class="section">
		  ...
		  <div class="section-body">
		  	<div class="row">
		  		<div class="col-6">
		  			<h2 class="section-title">All Category Data</h2>
		  		</div>
		  		<div class="col-6">
		  				...
		  				<table class="table" id="table-1">
		  					...
		  					@foreach($categories as $key => $category)
		  						<tr>
		  							...
		  							<td>{{ $category->name }}</td>
		  							<td>
		  								<img src="{{ asset('storage/category_image/'.$category->image) }}" class="img-responsive" height="50" width="50" alt="">
		  							</td>
		  							<td>
		  								<div class="btn-group">
		  									<a href="{{ route('category.edit', $category->id) }}" class="btn btn-info btn-md"><i class="fas fa-pencil-alt"></i></a>	
		  									<a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $category->id }})" data-target="#DeleteModal" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></a>
		  								</div>
		  							</td>
		  						</tr>
		  						@endforeach
