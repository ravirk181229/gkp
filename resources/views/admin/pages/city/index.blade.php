	...
	@section('main-content')
		<section class="section">
		  ...
		  <div class="section-body">
		  	<div class="row">
		  		<div class="col-6">
		  			<h2 class="section-title">All City Data</h2>
		  		</div>
		  		<div class="col-6">
		  				...
		  				<table class="table" id="table-1">
		  					...
		  					@foreach($cities as $key => $city)
		  						<tr>
		  							...
		  							<td>
		  								<div class="btn-group">
		  									<a href="{{ route('city.edit', $city) }}" class="btn btn-info btn-md"><i class="fas fa-pencil-alt"></i></a>
		  									<a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $city->id }})" data-target="#DeleteModal" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></a>
		  								</div>
		  							</td>
		  						</tr>
		  						@endforeach
