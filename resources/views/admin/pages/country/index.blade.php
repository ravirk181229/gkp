	...
	@section('main-content')
		<section class="section">
		  ...
		  <div class="section-body">
		  	<div class="row">
		  		<div class="col-6">
		  			<h2 class="section-title">All Country Data</h2>
		  		</div>
		  		<div class="col-6">
		  			<div class="float-right">
		  				<a href="{{ route('country.create') }}" class="btn btn-primary">CREATE COUNTRY</a>
		  			</div>
		  		</div>
		  	</div>				 
		  				...
		  				<table class="table" id="table-1">
		  					...
		  					@foreach($countries as $key => $country)
		  						<tr>
		  							...
		  							<td>
		  								<div class="btn-group">
		  									<a href="{{ route('country.edit', $country->id) }}" class="btn btn-info btn-md"><i class="fas fa-pencil-alt"></i></a>		  									
		  									<a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $country->id }})" data-target="#DeleteModal" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></a>
		  								</div>
		  							</td>
		  						</tr>
		  						@endforeach
