	...
	@section('main-content')
		<section class="section">
		  ...
		  <div class="section-body">
		  	<div class="row">
		  		<div class="col-6">
		  			<h2 class="section-title">All State Data</h2>
		  		</div>
		  		<div class="col-6">
		  			<div class="float-right">
		  				<a href="{{ route('state.create') }}" class="btn btn-primary">CREATE STATE</a>
		  			</div>
		  		</div>
		  	</div>				 
		  				...
		  				<table class="table" id="table-1">
		  					...
		  					@foreach($states as $key => $state)
		  						<tr>
		  							...
		  							<td>
		  								<div class="btn-group">
		  									<a href="{{ route('state.edit', $state) }}" class="btn btn-info btn-md"><i class="fas fa-pencil-alt"></i></a>
		  									<a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $state->id }})" data-target="#DeleteModal" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></a>
		  								</div>
		  							</td>
		  						</tr>
		  						@endforeach
