	...
	@section('main-content')
		<section class="section">
		  ...
		  <div class="section-body">
		  	<div class="row">
		  		<div class="col-6">
		  			<h2 class="section-title">All Amenity Data</h2>
		  		</div>
		  		<div class="col-6">
		  				...
		  				<table class="table" id="table-1">
		  					...
		  					@foreach($amenities as $key => $amenity)
		  						<tr>
		  							...
		  							<td>
		  								<div class="btn-group">
		  									<a href="{{ route('amenity.edit', $amenity->id) }}" class="btn btn-info btn-md"><i class="fas fa-pencil-alt"></i></a>	
		  									<a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $amenity->id }})" data-target="#DeleteModal" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></a>
		  								</div>
		  							</td>
		  						</tr>
		  						@endforeach
...
{{-- End Modal --}}
	...
	<script type="text/javascript">
	   ...
	   {
	       var id = id;
	       var url = '{{ route("amenity.destroy", ":id") }}';
